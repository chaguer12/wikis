...
<section class="ml-64 ">   
        ...
        <label for="categoryName" class="block mb-2 text-sm font-medium text-gray-600">New Category image:</label>
        <input type="file" id="categoryName" name="catImg" class="w-full px-4 py-2 border rounded-md">
